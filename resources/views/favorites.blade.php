...
@section('content')
    <x-content @class(['mt-10'])>
        ...
        <div class="flex flex-wrap flex-row mt-[35px] shrink-[0] gap-[20px] sm:flex-col sm:align-middle sm:justify-center" id="favoritesProducts">
