<div {{ $attributes->class(["w-[286px] h-[375px] flex flex-col justify-between border rounded-[5px] p-[16px] mr-[10px] grow-0 shrink-[0] mb-[10px] "]) }}>
    <a href="#" >
    ...
    <div class="flex flex-row justify-between">
        <p class="font-[Manrope] font-normal not-italic text-[14px] text-gray">г. Брянск</p>
    ...
    <p class="font-[Manrope] font-normal not-italic text-[16px] text-black break-keep">Доска сухая строганная оптом от производителя</p>
    <p class="font-[Manrope] font-bold not-italic text-[16px] text-black">Цена договорная</p>
</div>