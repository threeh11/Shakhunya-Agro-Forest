@props([
    ...
    <div class="flex flex-col w-[286px] h-[375px] border border-[#CCCCCC] rounded-[5px] p-[16px] z-2">
        ...
        <div class="flex flex-row mt-[8px]">
            <!-- <p class="font-[Manrope] font-normal not-italic text-[14px] text-gray">г. {{ $city }}</p> -->
        ...
        <div class="flex flex-col grow justify-between mt-[8px]">
            <p class="font-[Manrope] font-normal not-italic text-[20px] font-bold text-black break-keep">{{ $name }}</p>
