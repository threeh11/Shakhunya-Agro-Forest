...
<header class="bg-head">
    <div class="flex flex-row justify-around items-center justify-items-center w-[80%] mx-auto sm:flex-col lg:w-[90%]">
        <div class="w-[30%] py-[28px] sm:w-[100%] sm:flex sm:justify-center sm:py-[20px]">
            <p class="text-black font-['Manrope'] non-italic text-2xl font-bold leading-8 lg:text-lg">
                {{ env('APP_NAME') }}
            </p>
        </div>
        <div class="w-[70%] py-[28px] flex flex-row flex-wrap justify-between rounded-[5px] border-[1px solid greyLight] box-border min-h-min py-[16px]">
            <div class="flex border-[greyLight] w-[60%] focus:border-grey sm:w-[100%]">
                <label class="flex items-center w-[100%] h-[46px] rounded border border-grayLight ">
                    ...
                    <input type="text" placeholder="Поиск материалов" class="w-full max-w-xs bg-head border-none text-grey focus:outline-none" maxlength="30">
                </label>
            </div>
            <p class="flex items-center text-black font-['Manrope'] non-italic desktop2xl:text-xl font-normal leading-8 sm:hidden">
                +7 (964) 863-78-78
            </p>
        </div>
    </div>
