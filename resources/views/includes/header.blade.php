<header class="bg-head">
    <div class="flex flex-row items-center justify-items-center w-[62.7083333%] mx-auto sm:flex-col lg:w-[90%]">
        <div class="w-[18.6046512%] py-[35px] sm:w-[100%] sm:flex sm:justify-center sm:py-[20px]">
            <a href="{{ route('index') }}" class="text-black whitespace-nowrap font-['Manrope'] non-italic text-[24px] font-bold leading-8 lg:text-lg">
                {{ env('APP_NAME') }}
            </a>
        </div>
        <div class="pl-[82px] w-[57.8125%] flex flex-row border-[greyLight] focus:border-grey sm:w-[100%]">
            <label class="flex w-[97.3%] items-center h-[46px] rounded border border-grayLight ">
        ...
        <a href="{{ route('favorites') }}" class="flex flex-col items-center justify-between mx-auto h-[46px] px-[49px] cursor-pointer">
        ...
        <p class="flex items-center text-black font-['Manrope'] non-italic desktop2xl:text-xl font-normal whitespace-nowrap leading-8 sm:hidden">
            +7 (964) 863-78-78
        </p>
    </div>
</header>
