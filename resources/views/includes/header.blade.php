<header>
    <form action="{{ route('search') }}" method="POST" class="bg-head">
        @csrf
        <div class="flex flex-row items-center justify-items-center w-[62.7083333%] mx-auto lg:flex-col lg:w-[90%] lg:gap-[18px]">
            ...
            <div class="flex flrx row sm:mb-[20px] w-[100%] lg:order-3 lg:mb-[18px]">
                <div class="pl-[82px] w-[100%] flex flex-row border-[greyLight] focus:border-grey sm:w-[70%] sm:pl-0 ">
                    <label class="flex w-[97.3%] items-center h-[46px] rounded border border-grayLight sm:w-[100%]">
                        ...
                        <input type="text" name="search" placeholder="Поиск материалов" class="w-full  bg-head border-none text-grey focus:outline-none" maxlength="30">
                    </label>
                </div>
