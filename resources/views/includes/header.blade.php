...
<header class="bg-head">
    <div class="flex flex-row justify-around items-center justify-items-center container w-[80%] mx-auto">
        ...
        <div class="w-[70%] py-[28px] flex flex-row justify-between rounded-[5px] border-[1px solid greyLight] box-border min-h-min">
            <div class="flex border-[greyLight] w-[100] focus:border-grey">
                <label class="flex items-center w-[100%] h-[46px] rounded border border-greyLight">
                    ...
                    <input type="text" placeholder="Поиск материалов" class="border-none w-full max-w-xs bg-transparent text-grey focus:outline-none" maxlength="30">
                </label>
            </div>
