<div class="drop-shadow-2xl w-[500px] h-[650px] top-[20%] left-[20%] fixed rounded-xl bg-[#FFFFFF]" id="modalBuy">
    ...
    <div class="absolute top-0 right-0 m-[20px]">
    ...
    <form action="" class="px-[19px] pt-0 pb-[25px]">
        <div class="flex flex-col border-none">
            <x-modalInput title="Ваше имя" name="name"/>
            <x-modalInput title="Телефон" name="name"/>
            <x-modalInput title="Электронная почта" name="name"/>
            <label>
                <p class="border-solid text-[#333333] font-[Manrope] text-base font-bold pb-[6px]">
                    Текст заказа
                </p>
                <textarea class="pl-3 w-full h-32 border rounded border-solid border-[#CCCCCC] resize-none" type="text"></textarea>
            </label>
            <div class="pt-6">
                <label>
                    <input class="w-[60%] h-11 text-center rounded text-[#333333] font-[Manrope] text-base font-normal bg-[#FFED4E] text-base leading-5" value="Отправить">
                </label>
            </div>
        </div>
    </form>
